...
public class RegionController extends BaseController
{
     ...
     * 查询区域管理列表
     */
    @PreAuthorize("@ss.hasPermi('manager:region:list')")
    @GetMapping("/list")
     ...
     * 导出区域管理列表
     */
    @PreAuthorize("@ss.hasPermi('manager:region:export')")
     ...
     * 获取区域管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('manager:region:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增区域管理
     */
    @PreAuthorize("@ss.hasPermi('manager:region:add')")
     ...
     * 修改区域管理
     */
    @PreAuthorize("@ss.hasPermi('manager:region:edit')")
     ...
     * 删除区域管理
     */
    @PreAuthorize("@ss.hasPermi('manager:region:remove')")
